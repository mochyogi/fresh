...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?= Url::base() ?>/themes/metronic/global/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/global/plugins/simple-line-icons/simple-line-icons.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css" rel="stylesheet" type="text/css" />
        <!-- END GLOBAL MANDATORY STYLES -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <link href="<?= Url::base() ?>/themes/metronic/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/global/plugins/morris/morris.css" rel="stylesheet" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/global/plugins/fullcalendar/fullcalendar.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/global/plugins/jqvmap/jqvmap/jqvmap.css" rel="stylesheet" type="text/css" />
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL STYLES -->
        <!-- <link href="<?= Url::base() ?>/themes/metronic/css/components-md.min.css" rel="stylesheet" id="style_components" type="text/css" /> -->
        <link href="<?= Url::base() ?>/themes/metronic/global/css/components-md.min.css" rel="stylesheet" id="style_components" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/global/css/plugins-md.min.css" rel="stylesheet" type="text/css" />
        <!-- END THEME GLOBAL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
<!--         <link href="<?= Url::base() ?>/themes/metronic/css/layout.min.css" rel="stylesheet" type="text/css" /> -->
        <link href="<?= Url::base() ?>/themes/metronic/layouts/layout5/css/layout.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/layouts/layout5/css/custom.min.css" rel="stylesheet" type="text/css" />
<!--         <link href="<?= Url::base() ?>/themes/metronic/css/darkblue.min.css" rel="stylesheet" type="text/css" /> -->
                    ...
                    <div class="container-fluid">
                        <div class="clearfix navbar-fixed-top">
                            ...
                            <a id="index" class="page-logo" href="index.html">
                                <img src="<?= Url::base() ?>/themes/metronic/img/logo.png" alt="Logo"> </a>
                            <!-- END LOGO -->
                            <!-- BEGIN SEARCH -->
                            <!-- END SEARCH -->
                        ...
                        <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
                            ...
                            <ul class="media-list list-items">
                                <li class="media">
                                    ...
                                    <img class="media-object" src="../themes/metronic/layouts/layout/img/avatar3.jpg" alt="...">
                                ...
                                <li class="media">
                                    <img class="media-object" src="../themes/metronic/layouts/layout/img/avatar1.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object" src="../themes/metronic/layouts/layout/img/avatar4.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="media-object" src="../themes/metronic/layouts/layout/img/avatar2.jpg" alt="...">
                                    <div class="media-body">
                            ...
                            <ul class="media-list list-items">
                                <li class="media">
                                    ...
                                    <img class="media-object" src="../themes/metronic/layouts/layout/img/avatar6.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object" src="../themes/metronic/layouts/layout/img/avatar7.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="media-object" src="../themes/metronic/layouts/layout/img/avatar8.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object" src="../themes/metronic/layouts/layout/img/avatar9.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    <img class="media-object" src="../themes/metronic/layouts/layout/img/avatar10.jpg" alt="...">
                                    <div class="media-body">
                                ...
                                <li class="media">
                                    ...
                                    <img class="media-object" src="../themes/metronic/layouts/layout/img/avatar11.jpg" alt="...">
                                    <div class="media-body">
                        ...
                        <div class="page-quick-sidebar-item">
                            <div class="page-quick-sidebar-chat-user">
                                ...
                                <div class="page-quick-sidebar-chat-user-messages">
                                    <div class="post out">
                                        <img class="avatar" alt="" src="../themes/metronic/layouts/layout/img/avatar3.jpg" />
                                        <div class="message">
                                    ...
                                    <div class="post in">
                                        <img class="avatar" alt="" src="../themes/metronic/layouts/layout/img/avatar2.jpg" />
                                        <div class="message">
                                            <span class="arrow"></span>
...
<![endif]-->
        <!-- BEGIN CORE PLUGINS -->
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/jquery.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/js.cookie.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/jquery.blockui.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js" type="text/javascript"></script>
        <!-- <script src="<?= Url::base() ?>/themes/metronic/js/bootstrap-switch.min.js" type="text/javascript"></script> -->
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/moment.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/bootstrap-daterangepicker/daterangepicker.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/morris/morris.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/morris/raphael-min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/counterup/jquery.waypoints.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/counterup/jquery.counterup.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/amcharts/amcharts/amcharts.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/amcharts/amcharts/serial.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/amcharts/amcharts/pie.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/amcharts/amcharts/radar.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/amcharts/amcharts/themes/light.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/amcharts/amcharts/themes/patterns.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/amcharts/amcharts/themes/chalk.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/amcharts/ammap/ammap.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/amcharts/ammap/maps/js/worldLow.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/amcharts/amstockcharts/amstock.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/fullcalendar/fullcalendar.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/horizontal-timeline/horizontal-timeline.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/flot/jquery.flot.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/flot/jquery.flot.resize.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/flot/jquery.flot.categories.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/jquery-easypiechart/jquery.easypiechart.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/global/plugins/jquery.sparkline.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.vmap.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.vmap.russia.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.vmap.world.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.vmap.europe.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.vmap.germany.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.vmap.usa.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.vmap.sampledata.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="<?= Url::base() ?>/themes/metronic/global/scripts/app.min.js" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="<?= Url::base() ?>/themes/metronic/pages/scripts/dashboard.min.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL SCRIPTS -->
        <!-- BEGIN THEME LAYOUT SCRIPTS -->
        <script src="<?= Url::base() ?>/themes/metronic/layouts/layout5/scripts/layout.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/layouts/global/scripts/quick-sidebar.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/layouts/global/scripts/quick-nav.min.js" type="text/javascript"></script>
