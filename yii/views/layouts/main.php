...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?= Url::base() ?>/themes/metronic/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/css/simple-line-icons.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/css/bootstrap-switch.min.css" rel="stylesheet" type="text/css" />
        <!-- END GLOBAL MANDATORY STYLES -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <link href="<?= Url::base() ?>/themes/metronic/css/daterangepicker.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/css/morris.css" rel="stylesheet" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/css/fullcalendar.min.css" rel="stylesheet" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/css/jqvmap.css" rel="stylesheet" type="text/css" />
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL STYLES -->
        <!-- <link href="<?= Url::base() ?>/themes/metronic/css/components-md.min.css" rel="stylesheet" id="style_components" type="text/css" /> -->
        <link href="<?= Url::base() ?>/themes/metronic/css/components-md.css" rel="stylesheet" id="style_components" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/css/plugins-md.min.css" rel="stylesheet" type="text/css" />
        <!-- END THEME GLOBAL STYLES -->
        <!-- BEGIN THEME LAYOUT STYLES -->
<!--         <link href="<?= Url::base() ?>/themes/metronic/css/layout.min.css" rel="stylesheet" type="text/css" /> -->
        <link href="<?= Url::base() ?>/themes/metronic/css/layout.css" rel="stylesheet" type="text/css" />
        <link href="<?= Url::base() ?>/themes/metronic/css/custom.min.css" rel="stylesheet" type="text/css" />
...
<![endif]-->
        <!-- BEGIN CORE PLUGINS -->
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/bootstrap.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/js.cookie.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.slimscroll.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.blockui.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/bootstrap-switch.js" type="text/javascript"></script>
        <!-- <script src="<?= Url::base() ?>/themes/metronic/js/bootstrap-switch.min.js" type="text/javascript"></script> -->
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="<?= Url::base() ?>/themes/metronic/js/moment.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/daterangepicker.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/morris.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/raphael-min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.waypoints.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.counterup.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/amcharts.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/serial.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/pie.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/radar.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/light.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/patterns.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/chalk.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/ammap.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/worldLow.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/amstock.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/fullcalendar.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/horizontal-timeline.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.flot.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.flot.resize.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.flot.categories.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.easypiechart.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/jquery.sparkline.min.js" type="text/javascript"></script>
        ...
        <script src="<?= Url::base() ?>/themes/metronic/js/app.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/app.min.js" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="<?= Url::base() ?>/themes/metronic/js/dashboard.js" type="text/javascript"></script>
        <!-- <script src="<?= Url::base() ?>/themes/metronic/js/dashboard.min.js" type="text/javascript"></script> -->
        <!-- END PAGE LEVEL SCRIPTS -->
        <!-- BEGIN THEME LAYOUT SCRIPTS -->
        <script src="<?= Url::base() ?>/themes/metronic/js/layout.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/quick-sidebar.min.js" type="text/javascript"></script>
        <script src="<?= Url::base() ?>/themes/metronic/js/quick-nav.min.js" type="text/javascript"></script>
